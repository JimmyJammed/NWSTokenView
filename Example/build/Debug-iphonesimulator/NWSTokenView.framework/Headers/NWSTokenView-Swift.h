...
SWIFT_CLASS("_TtC12NWSTokenView8NWSToken")
@interface NWSToken : UIView
@property (nonatomic, strong) UITextView * __nonnull hiddenTextView;
@property (nonatomic) BOOL isSelected;
+ (NWSToken * __nullable)initWithTitle:(NSString * __nonnull)title image:(UIImage * __nullable)image;
...
SWIFT_CLASS("_TtC12NWSTokenView12NWSTokenView")
@interface NWSTokenView : UIView <UIScrollViewDelegate, UITextViewDelegate>
@property (nonatomic, strong) UITextView * __nonnull textView;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)awakeFromNib;
...
///
/// \returns  NWSToken
- (NWSToken * __nonnull)tokenForIndex:(NSInteger)index;
...
///
/// \returns  NWSToken
- (void)didTapToken:(UITapGestureRecognizer * __nonnull)tapGesture;
- (void)selectToken:(NWSToken * __nonnull)token;
